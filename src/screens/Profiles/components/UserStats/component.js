      ...
      <View style={styles.graphics}>
        ...
        <View style={styles.categoryBreakdown}>
          ...
          <View style={styles.categoryOverlay}>
            <StyledText bold size="xlarge" color="dark">{`${Number(primaryGenre.percent || 0).toFixed(
              0,
            )}%`}</StyledText>
        ...
        <View style={styles.legendWrap}>
          {displayGenres.map(genre => (
            <View style={{ flexDirection: 'row' }}>
              <StyledText size="xsmall" textStyle={{ color: genre.color }}>{`${Number(genre.percent || 0).toFixed(
                0,
              )}%`}</StyledText>
              ...
              <View style={{ flex: 1, justifyContent: 'center' }}>
                <View
                  style={{ width: `${genre.relativeSize}%`, height: 6, backgroundColor: genre.color, borderRadius: 8 }}
                />
              </View>
            </View>
          ))}
